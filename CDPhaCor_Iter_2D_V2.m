function [CD_correct, dphi_correct, phi_fit, cc_fit, mask_static_refined] = CDPhaCor_Iter_2D_V2(mag1, mag2, dphi, Z1Z2product, mask_static, mask_brain, deg, Niter, bBatch)
